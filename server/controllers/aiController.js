...
export const enhanceJobDescription = async (req, res) => {
    try {
        ...
        const response = await ai.chat.completions.create({
            ...
            messages: [
                {   role: "system",
                    content: "You are an expert in resume writing. Your task is to enhance the job description of a resume. The job description should only be 1-2 sentences also highlighting key responsibilities and achievements. Use action verbs and quantifiable results where possible. Make it ATS - friendly, and only return text no options or anything else" },
                {
                    role: "user",
                    content: userContent,
                },

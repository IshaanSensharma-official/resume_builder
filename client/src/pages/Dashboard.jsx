import { FilePen, FilePenLineIcon, PencilIcon, PlusIcon, TrashIcon, Upload, UploadCloud, UploadCloudIcon, XIcon } from 'lucide-react'
...
const Dashboard = () => {
    ...
    // modal visibility for uploading an existing resume
    ...
    // stop propagation when deleting so the outer card's click handler doesn't fire
    const deleteResume = async (event, resumeId) => {
    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-2 sm:flex flex-wrap gap-4'>
                ...
                {allResumes.length === 0 && (
                    <p className="w-full text-center text-slate-500 mt-8">
                        You have no resumes yet. Create one or upload an existing file.
                    </p>
                )}

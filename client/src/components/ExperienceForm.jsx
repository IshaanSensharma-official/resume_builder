...
// ✅ removed wrong: import { data } from 'react-router-dom'
...
const ExperienceForm = ({ data, onChange }) => {
    ...
    const generateDescription = async (index) => {
        ...
        try {
            const { data: responseData } = await api.post('/api/ai/enhance-job-desc',  // ✅ added leading /
                { userContent: prompt },
                { headers: { Authorization: token } }  // ✅ fixed: header → headers
            )
                            ...
                            <div className="space-y-2">
                                <div className='flex items-center justify-between'>
                                    ...
                                    <button
                                        ...
                                        // ✅ fixed: generateDescription === index → generatingIndex === index
